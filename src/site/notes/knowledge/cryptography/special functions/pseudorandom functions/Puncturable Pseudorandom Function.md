---
{"dg-publish":true,"permalink":"/knowledge/cryptography/special-functions/pseudorandom-functions/puncturable-pseudorandom-function/","dg-note-properties":{}}
---

## Syntax

> [!definition] Puncturable Pseudorandom Function
> A puncturable pseudorandom function (PPRF) is defined to be a triple of [[daily/Temp/PPT\|daily/Temp/PPT]] algorithms $\text{PPRF} = (\text{Gen}, \text{Puncture}, \text{Eval})$ with the following syntax:
...
> For any $d(n) = \text{poly}(n)$ and any [[daily/Temp/PPT\|daily/Temp/PPT]] algorithm $\mathcal A$ the following is negligible: 
> $$\left|\; 
