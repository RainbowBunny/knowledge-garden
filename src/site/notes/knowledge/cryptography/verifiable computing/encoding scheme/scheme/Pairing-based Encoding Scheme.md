---
{"dg-publish":true,"permalink":"/knowledge/cryptography/verifiable-computing/encoding-scheme/scheme/pairing-based-encoding-scheme/","dg-note-properties":{}}
---
...
> ### Parameters
> - $p$: Prime.
> - $\mathbb G$: Source [[knowledge/math/algebra/structures/groups/special groups/Cyclic Groups#Basic Definition\|Cyclic Group]] of order $p$.
> - $\mathbb G_T$: Target [[knowledge/math/algebra/structures/groups/special groups/Cyclic Groups#Basic Definition\|Cyclic Group]] of order $p$.
> - $g$: A fixed generator of $\mathbb G$.
> - $e: \mathbb G \times \mathbb G \rightarrow \mathbb G_T$: The [[knowledge/math/algebra/properties/Bilinear#Basic Definition\|Bilinear]] map that satisfies:
